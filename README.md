...
- [x] Tweaks some grindy/slow aspects of the game like the Mental State (Mind), Practice Skill Exp Rate, Extreme Volatility of everything during GC breakthroughs, Feng Shui requirements (Blessed etc).
- [x] Changes the cost of Skill Learning (Easy).
- [x] Increases Base Move Speed of Disciples (+1).
- [x] Makes slow events faster (City mainly).
- [x] Qi Gathering stabilization completes in 1 day instead of 5 days (optional: make sure you edit your other mods to display it correctly).
